...
import fr.smabtp.test.domain.Employee;
import fr.smabtp.test.repository.EmployeeRepository;
...
/**
 * REST controller for managing {@link fr.smabtp.test.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
