...
import fr.smabtp.test.config.Constants;
import fr.smabtp.test.domain.Authority;
import fr.smabtp.test.domain.User;
import fr.smabtp.test.repository.AuthorityRepository;
import fr.smabtp.test.repository.UserRepository;
import fr.smabtp.test.security.AuthoritiesConstants;
import fr.smabtp.test.service.MailService;
import fr.smabtp.test.service.UserService;
import fr.smabtp.test.service.dto.PasswordChangeDTO;
import fr.smabtp.test.service.dto.UserDTO;
import fr.smabtp.test.web.rest.errors.ExceptionTranslator;
import fr.smabtp.test.web.rest.vm.KeyAndPasswordVM;
import fr.smabtp.test.web.rest.vm.ManagedUserVM;
