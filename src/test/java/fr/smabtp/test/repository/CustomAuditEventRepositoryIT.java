...
import fr.smabtp.test.config.audit.AuditEventConverter;
import fr.smabtp.test.domain.PersistentAuditEvent;
...
import static fr.smabtp.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
